...
switch scene
{
    ...
    case 10:
        ...
        break
    case 11:
        cutscene_audio_fade(cutscene_music, 0, 300, 0.25, 0)
        break
    case 12:
        cutscene_event_wildeast_stamp(spr_wild_east_stamp_2, 253, 150, 10, 50)
        break
    case 13:
        cutscene_audio_fade(cutscene_music, 1, 300, 0.75, 1)
        break
    case 14:
        cutscene_dialogue()
        with (msg)
    ...
    case 20:
        ...
        break
    case 21:
        scr_music_sudden_stop(cutscene_music, 5, 0)
        cutscene_advance()
    case 22:
        cutscene_dialogue()
        with (msg)
    ...
    case 29:
        ...
        with (msg)
        {
            ...
            if (message_current == 1 && counter == 0)
                scr_music_sudden_stop(other.cutscene_music, 5, 1)
        }
        break
    case 30:
        scr_music_sudden_stop(other.cutscene_music, 5, 0)
        cutscene_advance()
        break
    case 31:
    ...
    case 32:
        ...
        break
    case 33:
        cutscene_npc_action_sprite(actor_ace, actor_ace.up_sprite, 0.2, 1)
        break
    case 34:
        cutscene_wait(0.5)
        break
    ...
    case 46:
        ...
        break
    case 47:
        cutscene_audio_fade(cutscene_music, 0, 500, 1, 0, 1)
        break
    case 48:
    ...
    case 52:
        ...
        break
    case 53:
        cutscene_npc_action_sprite(actor_starlo, 221, 0, 1)
        actor_starlo.image_index = 0
        cutscene_npc_action_sprite(actor_clover, 30, 0, 1)
        cutscene_advance(54)
        break
    case 54:
    ...
    case 56:
        ...
        if (actor_clover.image_index >= 6)
            ...
            cutscene_animation_end(actor_starlo, 1)
        break
    case 57:
        cutscene_npc_action_sprite(actor_clover, 31, 0.5, 1, 0)
    case 58:
        cutscene_wait(1)
        break
    case 59:
    ...
    case 62:
        ...
        break
    case 63:
        cutscene_npc_action_sprite(actor_starlo, 222, 0, 1, 0)
        cutscene_advance(64)
        break
    case 64:
        cutscene_camera_move(480, 440, 3, 1)
        cutscene_advance(65)
        break
    case 65:
    ...
    case 80:
        ...
        break
    case 81:
        cutscene_camera_move(520, 485, 3, 0)
        break
    case 82:
        cutscene_audio_fade(cutscene_music, 0, 300, 0.35, 0, 1)
        break
    case 83:
        scr_cutscene_end()
