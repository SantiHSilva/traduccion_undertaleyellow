function scr_battle_core_directory_enemy_2_name(argument0, argument1) //gml_Script_scr_battle_core_directory_enemy_2_name
{
    ...
    else if (game_mode == "yellow")
    {
        ...
        {
            var battle_enemy_name_2 = global.battle_enemy_name_2
            battle_menu_option_x = (obj_dialogue_box_battle.x + argument0)
            battle_menu_option_y = (obj_dialogue_box_battle.y + argument1)
