function scr_generate_battle_sweet_corn_solo() //gml_Script_scr_generate_battle_sweet_corn_solo
{
    ...
    instance_create(268, 240, obj_sweet_corn_cob_a)
    instance_create(268, 240, obj_sweet_corn_husk_a)
