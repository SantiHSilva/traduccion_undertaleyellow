...
switch scene
{
            ...
            switch message_current
            {
                ...
                case 3:
                    if (noloop_message < message_current)
                    {
                        ...
                        other.cutscene_music = audio_play_sound(mus_ones_past, 1, true)
                    }
                    break
            }
    ...
    case 32:
        ...
        break
    case 33:
        cutscene_camera_move(163, 230, 1, 0)
        break
    case 34:
        cutscene_wait(1.5)
        break
    ...
    case 38:
        ...
        if (round(obj_starlo_npc.image_index) == 72)
        {
            if (!audio_is_playing(snd_newhome_03_starlo_defeat))
                audio_play_sound(snd_newhome_03_starlo_defeat, 1, false)
        }
    ...
    case 41:
        ...
        if (round(obj_ceroba_npc.image_index) >= 119)
        {
            ...
            obj_ceroba_npc.action_sprite_stop = 0
    ...
    case 53:
        ...
        cutscene_battle_initiate("ceroba", 1, 0)
