function obtenerItemSpanish(argument0) //gml_Script_obtenerItemSpanish
{
    ...
    ds_map_add(objetos, "Candy Corn", "Maíz Dulce")
    ...
    ds_map_add(objetos, "Sponge Cake", "Pas. Esponjoso")
    ...
    ds_map_add(objetos, "Cnm. Cookie", "Galleta Canela")
    ...
    ds_map_add(objetos, "Band Merch Pin", "Broche de Banda")
    ...
    ds_map_add(objetos, "Silver Scarf", "Pañuelo Platea.")
