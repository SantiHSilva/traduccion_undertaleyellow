...
switch scene
{
    ...
    case 23:
        cutscene_npc_direction(obj_asgore_npc, "down")
        obj_asgore_npc.action_sprite = 1
    ...
    case 29:
        ...
        {
            if (obj_asgore_trident.draw_overlay == 0)
            {
                audio_play_sound(snd_hurt, 1, false)
                obj_asgore_trident.draw_overlay = 1
                obj_asgore_trident.vspeed = 0
            }
            if cutscene_wait(1)
            {
                var break_sound = audio_play_sound(snd_mirrorbreak1, 1, false)
                audio_sound_pitch(break_sound, 0.8)
                audio_play_sound(snd_soul_gameover_hit_break, 1, false)
