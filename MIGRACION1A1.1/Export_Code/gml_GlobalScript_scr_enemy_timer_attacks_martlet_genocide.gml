function scr_enemy_timer_attacks_martlet_genocide() //gml_Script_scr_enemy_timer_attacks_martlet_genocide
{
    ...
    if (instance_exists(obj_dialogue_box_battle_transformation_any) && obj_heart_battle_fighting_parent.moveable == 1)
    {
        if (enemy_attack == "Martlet Feather Fall" && (!instance_exists(obj_battle_enemy_attack_martlet_feather_fall_checker)))
            ...
            instance_create(obj_martlet_g_body.x, obj_martlet_g_body.y, obj_battle_enemy_attack_martlet_wing_gust_body)
