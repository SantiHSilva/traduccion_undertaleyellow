...
switch scene
{
    ...
    case 24:
        ...
        break
    case 25:
        obj_factory_02_conveyor_puzzle.conveyor_spawn_item = 1
    ...
    case 46:
        ...
        obj_factory_02_conveyor_puzzle.conveyor_puzzle_activate = 1
        break
    case 47:
        break
    case 48:
    ...
    case 51:
        if (obj_steamworks_factory_02_door.image_index >= (obj_steamworks_factory_02_door.image_number - 1))
        {
            ...
            obj_steamworks_factory_02_door.solid = 0
            audio_stop_sound(snd_rumble)
            audio_play_sound(snd_mart_impact_3, 1, false)
            cutscene_advance()
        }
        break
    case 52:
