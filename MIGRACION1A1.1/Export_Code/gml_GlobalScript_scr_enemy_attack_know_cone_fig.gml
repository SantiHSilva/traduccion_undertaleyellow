function scr_enemy_attack_know_cone_fig() //gml_Script_scr_enemy_attack_know_cone_fig
{
    var distance_factor_x = 15
    var distance_factor_y = 20
    var random_generator = irandom_range(0, 1)
    var random_generator_y = irandom_range(1, 3)
