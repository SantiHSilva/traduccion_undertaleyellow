...
{
    message[0] = "To be honest?#Not surprised."
    message_end = 0
}
else
    execute_normal = 1
if (execute_normal == 1)
{
    ...
    else if (global.last_action_selected_2 == "Action 1 Message 0")
    {
        ...
        {
            message[0] = "I'm an#excccellent#travel companion!"
            message_end = 0
        }
    }
    ...
    else
    {
        if (global.battle_enemy_name == "cactony slither duo")
        {
            ...
            {
                if instance_exists(obj_quote_battle_cactony_a)
                    random_number = obj_quote_battle_cactony_a.random_number
                else
                    random_number = irandom_range(0, 2)
                if (random_number == 0)
                {
                    message[0] = "I know just#what you need!"
                    message_end = 0
                }
                else if (random_number == 1)
                {
                    message[0] = "You, me,#perfect match#eh?"
                    message_end = 0
                }
                else if (random_number == 2)
                {
                    message[0] = "I can cheer#you right up!#Easy!"
                    message_end = 0
                }
            }
            else
