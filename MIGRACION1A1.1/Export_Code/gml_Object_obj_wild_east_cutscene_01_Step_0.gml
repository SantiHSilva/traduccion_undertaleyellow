switch scene
{
    ...
    case 2:
        ...
        break
    case 3:
        if (player_npc.npc_arrived == 1 && martlet.npc_arrived == 1)
            scene++
        break
    case 4:
        if scr_timer()
    ...
    case 23:
        ...
        {
            scene++
            audio_play_sound(mus_starlo_entrance, 1, false)
            timer = 75
        }
        break
    case 24:
    ...
    case 25:
        ...
        {
            audio_play_sound(mus_feisty, 1, true)
            starlo.image_speed = 0
            starlo.down_sprite_idle = 194
            starlo.action_sprite = 0
            scene++
            timer = 15
        }
        break
    ...
    case 31:
        ...
        {
            audio_play_sound(snd_shotweak, 1, false)
            scr_screenshake(6, 1)
        }
    ...
    case 33:
        ...
        {
            audio_play_sound(snd_shotmid, 1, false)
            scr_screenshake(6, 1)
        }
    ...
    case 35:
        ...
        {
            audio_play_sound(snd_attackhitcrit, 1, false)
            scr_screenshake(10, 1)
        }
    ...
    case 39:
        ...
        {
            starlo.action_sprite = 0
            mooch.action_sprite = 0
            ed.action_sprite = 0
            moray.action_sprite = 0
            ace.action_sprite = 0
        }
        ...
        if ed.npc_arrived
        {
            ...
            if (round(ed.image_index) == 7)
            {
                if (!audio_is_playing(snd_toy_squeak))
                    audio_play_sound(snd_toy_squeak, 1, false)
            }
            if (ed.image_index >= (ed.image_number - 1))
            {
                ed.image_speed = 0
    ...
    case 47:
        ...
        break
    case 48:
        if (ace.npc_arrived == 1 && mooch.npc_arrived == 1 && moray.npc_arrived == 1 && ed.npc_arrived == 1)
        {
            timer = 15
            scene++
        }
