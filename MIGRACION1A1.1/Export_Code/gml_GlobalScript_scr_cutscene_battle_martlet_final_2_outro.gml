function scr_cutscene_battle_martlet_final_2_outro() //gml_Script_scr_cutscene_battle_martlet_final_2_outro
{
    if live_call()
    ...
    switch scene
    {
        ...
        case 35:
            ...
            break
        case 36:
            obj_heart_battle_menu_fake_martlet.key_select_simulate = 1
            cutscene_advance()
            break
        case 37:
            cutscene_wait(0.5)
        ...
        case 90:
            ...
            flowey_laugh = audio_play_sound(snd_flowey_laugh, 1, false)
            cutscene_advance()
            break
        case 91:
            cutscene_wait(1)
        ...
        case 95:
            for (i = 0; i < array_length(shot); i++)
            {
                if (shot[i] != noone && (!instance_exists(shot[i])))
                {
                    ...
                    var hit_sound = audio_play_sound(snd_monster_damage_hit_critical, 1, false)
