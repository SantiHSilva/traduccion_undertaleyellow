function scr_generate_battle_frostermit_solo() //gml_Script_scr_generate_battle_frostermit_solo
{
    global.battle_enemy_name_1 = "frostermit a"
    ...
    instance_create(274, 198, obj_frostermit_body_a)
    global.enemy_damage_x = (obj_frostermit_body_a.x + 6)
    global.enemy_damage_y = obj_frostermit_body_a.y
    global.enemy_target_x = (obj_frostermit_body_a.x + 6)
    global.enemy_target_y = obj_frostermit_body_a.y
