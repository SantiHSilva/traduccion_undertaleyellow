function scr_determine_end_battle_flags_yellow() //gml_Script_scr_determine_end_battle_flags_yellow
{
    ...
    {
        if (global.enemy_spared == 1 && global.action_2_selected_count >= 5)
            global.flag[15] = 1
        else if (global.enemy_dead == 1)
            global.flag[15] = 3
        else
            global.flag[15] = 2
    }
    ...
    else if (battle_enemy_name == "martlet genocide")
    {
        ...
        else if (global.enemy_betrayed == 1)
        {
            global.snowdin_flag[13] = 3
            global.snowdin_flag[21] = 1
        }
        else if (global.enemy_spared == 1)
        {
            global.snowdin_flag[13] = 3
            global.snowdin_flag[21] = 0
        }
