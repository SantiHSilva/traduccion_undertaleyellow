...
switch scene
{
    ...
    case 10:
        ...
        if (obj_pl.x > 5670)
        {
            ...
            obj_player_npc.action_sprite = 1
    ...
    case 14:
        ...
        {
            cutscene_advance()
            var effect = audio_effect_create((1 << 0))
            effect.mix = 0.5
            effect.time = 0.1
    ...
    case 15:
        ...
        if (irandom(8) == 1)
        {
            var laugh = audio_play_sound(choose(23, 630), 1, false, random_range(0.3, 0.5), 0, random_range(0.6, 1.2))
    ...
    case 23:
        if (!audio_is_playing(mus_floweynew_yellow))
        {
            ...
            flow_mus = audio_play_sound(mus_floweynew_yellow, 1, false)
        }
        obj_player_npc.x += 2
