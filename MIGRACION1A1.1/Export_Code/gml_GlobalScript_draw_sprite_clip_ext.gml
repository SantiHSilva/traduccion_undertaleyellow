function draw_sprite_clip_ext(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11) //gml_Script_draw_sprite_clip_ext
{
    var s = argument0
