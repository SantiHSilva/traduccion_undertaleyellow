...
else if (enemy_dead == 0 && enemy_spared == 0)
{
    if (global.current_hp_enemy <= 0)
        sprite_index = spr_feisty_four_ed_hand_right
    else
        sprite_index = spr_feisty_four_ed_hand_right
}
...
if (obj_feisty_four_ed_legs.animating == 1)
{
    ...
    y = obj_feisty_four_ed_legs.hand_right_displacement_y
    image_angle = (hand_angle_max * ((obj_feisty_four_ed_legs.image_yscale - 1) / obj_feisty_four_ed_legs.max_rise))
}
else
{
    x = (obj_feisty_four_ed_legs.x - difference_x)
