if (obj_heart_battle_fighting_parent.moveable == 1 && no_loop == 0)
{
    script_execute(gml_Script_scr_battle_core_directory_enemy_attack_alarms)
    no_loop = 1
}
if (battle_box_resize_midfight == 1)
{
