...
switch scene
{
    ...
    case 0:
        ...
        {
            audio_play_sound(snd_ceroba_shield_impact, 1, false)
    ...
    case 8:
        ...
        break
    case 9:
        var execute_destroy = 1
        with (obj_ceroba_phase_2_bell)
        {
            if (bullet_destroy_self == 0)
                execute_destroy = 0
        }
        if (execute_destroy == 1)
        {
            if instance_exists(obj_battle_enemy_attack_ceroba_phase_2_attack_spawner)
            {
...
var default_alpha = 0
if (global.enemy_attacking == 1 && global.enemy_attack != "Ceroba Special Attack")
    default_alpha = 0.25
if (hit_show_timer > 0)
{
    hit_show_timer--
