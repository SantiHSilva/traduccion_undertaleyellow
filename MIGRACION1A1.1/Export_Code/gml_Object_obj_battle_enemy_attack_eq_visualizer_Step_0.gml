...
switch scene
{
    ...
    case 4:
    case 6:
        eq_bar_draw_warning_bars = 0
        cutscene_wait(0.1)
        break
    case 1:
    case 3:
    case 5:
        if (eq_bar_draw_warning_bars == 0)
        {
            eq_bar_draw_warning_bars = 1
...
for (i = 0; i < eq_bar_number; i++)
{
    ...
    if instance_exists(obj_heart_battle_fighting_parent)
    {
        ...
        if (soul.vulnerable == 1 && rectangle_in_rectangle(soul.bbox_left, soul.bbox_top, soul.bbox_right, soul.bbox_bottom, xx, yy, (xx + eq_bar_width), yy_2))
        {
