...
else if (enemy_dead == 0 && enemy_spared == 0)
{
    ...
    else if (global.enemy_low_hp == 1 && global.current_hp_enemy < global.max_hp_enemy)
...
image_xscale = starting_point_xscale
image_yscale = starting_point_yscale
if ((!((instance_exists(obj_text_damage_count) && global.fight_number == 1))) && enemy_dead == 0 && enemy_spared == 0 && image_alpha > 0)
{
