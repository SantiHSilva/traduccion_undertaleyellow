...
if (clover_cup_cutscene == 1 && (!global.dialogue_open))
{
    ...
    if (clover_npc.npc_arrived == 1)
    {
        clover_npc.image_alpha = 0
        clover_npc.npc_arrived = 0
