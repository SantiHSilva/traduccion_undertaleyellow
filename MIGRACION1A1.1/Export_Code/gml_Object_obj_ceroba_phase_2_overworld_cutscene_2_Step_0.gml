...
switch scene
{
    ...
    case 5:
        ...
        if (!instance_exists(obj_ending_flashback_02_noise))
            ...
            obj_ending_flashback_02_noise.fade_out = 1
        break
    case 6:
        cutscene_wait(1)
        break
    case 7:
        cutscene_npc_action_sprite(159, 860, 1, 0)
        break
    case 8:
    ...
    case 15:
        ...
        with (msg)
        {
            ...
            {
                other.cutscene_music = audio_play_sound(mus_kanako_reprise, 1, true)
    ...
    case 20:
        ...
        break
    case 21:
        cutscene_npc_action_sprite(159, 2777, 1, 0)
    ...
    case 25:
        ...
        break
    case 25.4:
        if cutscene_npc_action_sprite(159, 2901, 1, 0)
            scene = 25.6
    ...
    case 51.5:
        ...
        break
    case 52:
        obj_kanako_npc.npc_dynamic_depth = 0
    ...
    case 69:
        ...
        break
    case 70:
        obj_flashback_kanako_soul.fade_out = 1
        scene++
        break
    case 71:
    ...
    case 80:
        ...
        obj_kanako_npc.action_sprite = 1
