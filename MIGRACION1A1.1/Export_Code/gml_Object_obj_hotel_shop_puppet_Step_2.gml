...
if (action != "Override")
{
    ...
    {
        if (obj_dialogue_shop_parent.can_talk == 1 && obj_dialogue_shop_parent.characters > string_length(obj_dialogue_shop_parent.message[obj_dialogue_shop_parent.message_current]))
        {
