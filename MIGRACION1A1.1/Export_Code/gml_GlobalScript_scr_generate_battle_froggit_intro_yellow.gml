function scr_generate_battle_froggit_intro_yellow() //gml_Script_scr_generate_battle_froggit_intro_yellow
{
    global.battle_enemy_name_1 = "froggit intro"
    ...
    if (global.sound_carry_overworld == 0)
    {
        ...
        audio_sound_gain(mus_prebattle1_yellow, 1, 0)
        audio_sound_pitch(mus_prebattle1_yellow, 1)
        audio_play_sound(mus_prebattle1_yellow, 20, true)
    }
    audio_extend = 0
    global.sound_carry_battle = 0
    global.mettaton_voice_count = 1
    instance_create(170, 196, obj_froggit_intro_head_yellow)
    instance_create(170, 196, obj_froggit_intro_body_yellow)
    global.enemy_damage_x = obj_froggit_intro_body_yellow.x
    global.enemy_damage_y = obj_froggit_intro_body_yellow.y
    global.enemy_target_x = obj_froggit_intro_body_yellow.x
    global.enemy_target_y = obj_froggit_intro_body_yellow.y
