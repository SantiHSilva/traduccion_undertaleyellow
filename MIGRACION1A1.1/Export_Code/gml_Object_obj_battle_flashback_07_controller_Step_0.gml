...
switch scene
{
    ...
    case 9:
        ...
        if cutscene_npc_action_sprite(actor_martlet, 1465, 1, 0)
    ...
    case 11:
        ...
        break
    case 12:
        cutscene_npc_action_sprite(actor_martlet, 3743, 1, 1, 0)
        break
    case 13:
        cutscene_dialogue()
        with (msg)
        {
            ...
            if (cutoff >= string_length(message[message_current]))
            {
                ...
                {
                    action_sprite = 1
                    audio_play_sound(snd_flowey_martlet_melt, 1, false)
