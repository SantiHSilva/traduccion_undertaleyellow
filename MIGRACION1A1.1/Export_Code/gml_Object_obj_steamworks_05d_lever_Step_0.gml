...
if (global.route != 3)
{
    switch scene
    {
        ...
        case 12:
            ...
            break
        case 13:
            if (cutscene_camera_move(400, obj_pl.y, 1, 1) && obj_steamworks_05d_background.image_alpha >= 1)
                cutscene_advance()
...
else
{
    switch scene
    {
        ...
        case 1:
            ...
            break
        case 2:
            audio_play_sound(snd_lever_strain, 1, false)
            cutscene_advance()
            break
        case 3:
        ...
        case 11:
            ...
            {
                cutscene_advance(14)
                audio_play_sound(snd_geno_power_on, 1, false)
                scr_screenshake(1, 2)
            ...
            for (i = 0; i < array_length_1d(tile); i++)
                tile_set_alpha(tile[i], tile_alpha)
            var snd = audio_play_sound(snd_undertale_appear, 1, false)
