function scr_dialogue_battle_action_selected_action_3_insomnitot_b() //gml_Script_scr_dialogue_battle_action_selected_action_3_insomnitot_b
{
    ...
    else if (global.enemy_sparing_2 == 1)
    {
