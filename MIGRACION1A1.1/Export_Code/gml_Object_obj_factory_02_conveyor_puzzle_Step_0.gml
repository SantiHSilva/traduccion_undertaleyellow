...
if (conveyor_puzzle_activate == 1)
{
    conveyor_puzzle_activate = 0
    alarm[1] = 30
}
if (conveyor_puzzle_active == 1)
{
    ...
    if keyboard_multicheck_pressed(1)
        obj_conveyor_stamp_red.activate = 1
...
if conveyor_spawn_item
{
    ...
    if (conveyor_item_secret == 0)
    {
        ...
        audio_play_sound(snd_factory_puzzle_spawn_item, 1, false)
        instance_create_depth(420, 590, 950, obj_factory_02_conveyor_item_dog)
        conveyor_spawn_item = 0
