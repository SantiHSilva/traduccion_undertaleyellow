        ...
        switch other.npc_flag
        {
            ...
            case 2:
                ...
                else
                {
                    ...
                    if (other.item_got == 0 && scr_item("Band Merch Pin"))
                    {
                    ...
                    else if (other.item_got == 1)
                    {
                        if (message_current == 5 && other.is_talking == 1)
                        {
                            other.is_talking = 0
                    ...
                    else
                    {
                        ...
                        if (message_current == 5 && other.is_talking == 1)
                        {
                            audio_play_sound(snd_fail, 20, false)
                            other.waiter = 0
                            other.npc_flag = 3
                        }
                    }
            ...
            case 3:
                ...
                {
                    if (message_current == 3 && other.is_talking == 1)
                    {
                        other.is_talking = 0
                        audio_play_sound(snd_success, 20, false)
                    }
