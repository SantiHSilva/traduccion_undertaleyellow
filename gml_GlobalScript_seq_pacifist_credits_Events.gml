function seq_pacifist_credits_Moment_6() //gml_Script_seq_pacifist_credits_Moment_6
{
    room_goto(rm_credits_paci_intermission)
}

function seq_pacifist_credits_Moment_7() //gml_Script_seq_pacifist_credits_Moment_7
{
...
function seq_pacifist_credits_Moment_8() //gml_Script_seq_pacifist_credits_Moment_8
{
    if variable_global_exists("ending_sequence")
        layer_sequence_destroy(global.ending_sequence)
}

function seq_pacifist_credits_Moment_9() //gml_Script_seq_pacifist_credits_Moment_9
{
    var sale_number = 0
    for (var i = 1; i < array_length(global.extra_flag); i++)
    {
        if (global.extra_flag[i] == 1)
            sale_number += 1
    }
    if (sale_number <= 3)
...
function seq_pacifist_credits_Moment_10() //gml_Script_seq_pacifist_credits_Moment_10
{
