...
switch scene
{
    ...
    case 21:
        ...
        if cutscene_key_prompt()
        {
            ...
            obj_player_npc.can_walk = 0
            obj_starlo_npc.npc_direction = "right"
            obj_starlo_npc.can_walk = 0
    ...
    case 23:
        if (obj_starlo_npc.image_speed == 0)
        {
            ...
            if (cutscene_duel_delay == 0)
            {
                audio_play_sound(snd_duel_mark, 1, false)
                cutscene_advance()
            }
        }
        break
    ...
    case 53:
        ...
        break
    case 54:
        cutscene_camera_move((obj_starlo_npc.x + 80), obj_starlo_npc.y, 0.5, 0, 0)
        break
    case 55:
        cutscene_wait(0.5)
        break
    ...
    case 63:
        ...
        obj_ceroba_npc.image_alpha = 0
        cutscene_battle_initiate("ceroba genocide", 1, 0)
        break
}
