function scr_battle_core_directory_no_attack() //gml_Script_scr_battle_core_directory_no_attack
{
    ...
    else if (game_mode == "yellow")
    {
        ...
        {
            script_execute(gml_Script_scr_start_enemy_no_attack_martlet_pacifist)
            no_loop_can_attack = 1
        }
        else if (battle_enemy_name == "martlet genocide")
        {
            script_execute(gml_Script_scr_start_enemy_no_attack_martlet_genocide)
            no_loop_can_attack = 1
        }
        else if (battle_enemy_name == "dummy training pacifist")
        {
            script_execute(gml_Script_scr_start_enemy_no_attack_dummy_training_pacifist)
            no_loop_can_attack = 1
        }
        else if (battle_enemy_name == "axis" || battle_enemy_name == "axis genocide")
        {
            script_execute(gml_Script_scr_start_enemy_no_attack_axis)
            no_loop_can_attack = 1
        }
    }
}
