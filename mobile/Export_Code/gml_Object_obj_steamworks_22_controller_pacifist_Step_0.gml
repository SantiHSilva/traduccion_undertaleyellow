...
switch scene
{
    ...
    case 2:
        ...
        {
            audio_play_sound(snd_axis_energy_ball_explode, 1, false)
            audio_play_sound(snd_glass_break_2, 1, false)
            layer_set_visible("asset_broken_glass", 1)
            layer_set_visible("asset_glass_flash", 1)
            layer_set_visible("asset_glass_panel", 0)
            alarm[0] = 1
    ...
    case 6:
        ...
        layer_set_visible("asset_broken_glass", 0)
        cutscene_advance()
        break
    case 7:
    ...
    case 18:
        obj_camera.x = obj_pl.x
        if (obj_player_npc.npc_arrived == 1)
        {
    ...
    case 55:
        ...
        break
    case 56:
        cutscene_audio_fade(cutscene_music, 0, 500, 0.15, 0, 1)
        break
    case 57:
        cutscene_dialogue()
        with (msg)
...
if (scene >= 28 && energy_ball_deflect_noloop == 1)
{
    if instance_exists(obj_steamworks_22_energy_ball_fake_2)
    {
