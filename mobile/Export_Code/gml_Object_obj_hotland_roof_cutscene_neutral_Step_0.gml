...
switch scene
{
    ...
    case 23:
        ...
        if (syringe_noloop == 0 && obj_martlet_npc.image_index >= 8)
        {
            syringe_noloop = 1
    ...
    case 49:
        if cutscene_npc_action_sprite(3194, 3150, 1, 1, 1)
        {
            ...
            clover_shake = 1
            audio_play_sound(snd_flowey_laugh, 1, false)
            alarm[0] = 15
        }
        break
    case 50:
        obj_player_npc.npc_dynamic_depth = 0
        obj_player_npc.depth = (depth - 1)
        obj_flowey_npc.npc_dynamic_depth = 0
