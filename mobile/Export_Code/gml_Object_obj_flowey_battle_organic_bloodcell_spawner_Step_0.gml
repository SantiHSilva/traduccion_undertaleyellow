...
var rng = irandom(organic_spawn_chance_current)
if (rng == 1)
{
    organic_spawn_chance_current = organic_spawn_chance_max
    var cell = instance_create_depth(choose(-60, 700), irandom_range(-60, 540), -100, obj_flowey_battle_phase_2_organic_bloodcell)
