function scr_controls_battle_heart_blue_left() //gml_Script_scr_controls_battle_heart_blue_left
{
    if (global.player_1_using_keyboard == 1 && moveable == 1)
    {
        ...
        key_right_release = keyboard_check_released(global.player_1_control_keyboard_right)
    ...
    else if (global.player_1_using_gamepad == 1 && moveable == 1)
    {
        ...
        key_right_release = gamepad_button_check_released(0, global.player_1_control_gamepad_right)
