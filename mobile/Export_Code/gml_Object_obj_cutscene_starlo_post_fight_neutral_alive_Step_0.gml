...
switch scene
{
    ...
    case 33:
        ...
        break
    case 34:
        cutscene_npc_action_sprite(actor_starlo, 1276, 0.25, 1, 0)
        break
    case 35:
    ...
    case 40:
        ...
        break
    case 41:
        cutscene_npc_action_sprite(actor_starlo, actor_starlo.up_sprite, 0.2, 1, 0.2, 281, 0)
        break
    case 42:
        cutscene_wait(0.25)
        break
    ...
    case 53:
        ...
        with (msg)
        {
            ...
            prt[1] = 417
            prt[2] = 422
            if (message_current == 0 && other.no_loop_badge == 0)
            {
                audio_play_sound(snd_success, 1, false)
                other.no_loop_badge = 1
            }
        }
        break
    case 54:
