function scr_generate_battle_trihecta_together() //gml_Script_scr_generate_battle_trihecta_together
{
    global.battle_enemy_name_1 = "trihecta"
    ...
    instance_create(318, 196, obj_trihecta_together)
    global.enemy_damage_x = obj_trihecta_together.x
    global.enemy_damage_y = (obj_trihecta_together.y - 70)
    global.enemy_target_x = obj_trihecta_together.x
    global.enemy_target_y = (obj_trihecta_together.y - 70)
