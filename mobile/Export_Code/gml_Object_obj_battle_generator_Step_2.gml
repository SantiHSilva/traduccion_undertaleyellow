...
if (instance_exists(obj_dialogue_box_battle_transformation_any) && obj_heart_battle_fighting_parent.moveable == 1 && global.image_alpha_enemy_attacking_immunity == 0)
{
