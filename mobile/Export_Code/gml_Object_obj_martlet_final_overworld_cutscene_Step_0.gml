...
switch scene
{
    case 0:
        if (room == rm_battle)
            return;
        cutscene_music = audio_play_sound(mus_snowfall, 1, true)
    ...
    case 2:
        ...
        if (draw_alpha <= 0.01)
            draw_alpha = 0
        if (cutscene_camera_move(0, 0, 2, 0) && draw_alpha == 0)
            scene++
        break
    case 3:
        cutscene_wait(1)
    ...
    case 6:
        ...
        cutscene_npc_action_sprite(92, 2607, 1, 0)
        break
    case 7:
        cutscene_wait(1)
        break
    ...
    case 10:
        ...
        if cutscene_npc_action_sprite(92, 3080, 1, 0)
            ...
            switch message_current
            {
                ...
                case 21:
                    ...
                    if (!audio_is_playing(mus_nothing_but_the_truth))
                        other.cutscene_music = audio_play_sound(mus_nothing_but_the_truth, 1, false)
                    obj_chujin_npc.down_sprite_idle = 3519
                    obj_martlet_npc.down_sprite_idle = 267
                    break
                case 22:
