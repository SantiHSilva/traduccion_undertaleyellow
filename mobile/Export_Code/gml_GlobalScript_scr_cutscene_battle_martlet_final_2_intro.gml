function scr_cutscene_battle_martlet_final_2_intro() //gml_Script_scr_cutscene_battle_martlet_final_2_intro
{
    if live_call()
    ...
    switch scene
    {
        ...
        case 5:
            if (message_current == 10)
            {
                if (!audio_is_playing(mus_retribution))
                    global.battle_music = audio_play_sound(mus_retribution, 1, true)
                skippable = 0
                cutscene_wait(0.75)
            }
            break
        ...
        case 8:
            ...
            var flash_sound = audio_play_sound(snd_undertale_flash, 1, false)
            audio_sound_gain(flash_sound, 0.7, 0)
            scr_screenshake_battle_custom(6, 3)
            obj_martlet_final_2_base.martlet_sprites_reset = 1
            cutscene_advance()
            break
        case 9:
            cutscene_wait(1)
        ...
        case 11:
            fade_out_gui = 0
            obj_martlet_final_bg.fade_out = 0
