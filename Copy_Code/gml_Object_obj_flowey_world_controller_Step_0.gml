...
{
    case 0:
        entrance_sound = audio_play_sound(snd_flowey_world_entrance, 1, false)
        cutscene_advance()
        break
    case 1:
        ...
        {
            layer_set_visible("pixelate", 0)
            layer_set_visible("distort", 0)
            cutscene_advance()
        }
        break
    case 2:
    ...
    case 4:
        ...
        cutscene_music = audio_play_sound(mus_flowey_world, 1, true)
        cutscene_advance()
        break
    case 5:
    ...
    case 58:
        ...
        if cutscene_wait(2.5)
            cutscene_music = audio_play_sound(mus_flowey_soundscape, 1, false)
        break
    case 59:
        cutscene_advance()
        break
    ...
    case 72:
        ...
        break
    case 73:
        if (obj_flowey_world_lasers.lasers_active == 1)
        {
    ...
    case 100:
        ...
        fight_music = audio_play_sound(mus_flowey_final_boss_1_intro, 1, false)
        cutscene_advance()
        break
    case 101:
        cutscene_wait(1)
        ...
        switch glitch_number
        {
            ...
            case 6:
                if (mus_pos >= mus_length)
                {
                    ...
                    global.battle_music = audio_play_sound(mus_flowey_final_boss_1_main, 1, true)
                    cutscene_advance()
                }
                break
        }
    ...
    case 106:
        ...
        if (white_overlay_alpha < 0.01)
        {
            ...
            obj_battle_flowey_body_1.can_draw_ghost = 1
