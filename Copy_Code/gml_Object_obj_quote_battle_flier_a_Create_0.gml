...
{
    if (((global.enemy_dead_2 == 1 && global.fight_number == 2) || (global.enemy_dead_3 == 1 && global.fight_number == 3)) && global.battle_menu_number == 1)
    {
...
else if (global.battle_enemy_name == "flier penilla duo")
{
    if (global.enemy_dead_2 == 1 && global.fight_number == 2 && global.battle_menu_number == 1)
    {
        message[0] = "Ella era mi amiga#(creo)."
        message_end = 0
    }
    else
        execute_normal = 1
...
if (execute_normal == 1)
{
    ...
    else
    {
        if (global.battle_enemy_name == "flier trio")
        {
            if ((((global.enemy_dead_2 + global.enemy_spared_2) + global.enemy_dead_3) + global.enemy_spared_2) < 2)
            {
        ...
        else if (global.battle_enemy_name == "flier penilla duo")
        {
            ...
            {
                message[0] = "¿Es el arte lo que#les gusta a los#niños hoy en día?"
                message_end = 0
            }
            else
                execute_random = 1
