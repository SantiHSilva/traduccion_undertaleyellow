...
if (card_draw_warning_rectangle == 1)
{
    var rectangle_width = sprite_get_width(spr_attack_ace_card_back)
    var rectangle_height = sprite_get_height(spr_attack_ace_card_back)
