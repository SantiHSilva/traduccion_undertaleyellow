...
if instance_exists(obj_dialogue_box_battle_transformation_any)
{
    with (obj_dialogue_box_battle_transformation_any)
    {
        ...
        draw_rectangle_colour(bbox_left, bbox_top, (bbox_left + 4), bbox_bottom, _color_current, _color_current, _color_current, _color_current, 0)
        draw_rectangle_colour((bbox_right - 4), bbox_top, bbox_right, bbox_bottom, _color_current, _color_current, _color_current, _color_current, 0)
        draw_rectangle_colour(bbox_left, bbox_top, bbox_right, (bbox_top + 4), _color_current, _color_current, _color_current, _color_current, 0)
        draw_rectangle_colour(bbox_left, (bbox_bottom - 4), bbox_right, bbox_bottom, _color_current, _color_current, _color_current, _color_current, 0)
    }
}
