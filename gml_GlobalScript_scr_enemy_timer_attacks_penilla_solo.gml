function scr_enemy_timer_attacks_penilla_solo() //gml_Script_scr_enemy_timer_attacks_penilla_solo
{
    var enemy_attack = global.enemy_attack
    if (instance_exists(obj_dialogue_box_battle_transformation_any) && enemy_attack == "Penilla Drawing" && obj_heart_battle_fighting_parent.moveable == 1 && (!instance_exists(obj_battle_enemy_attack_penilla_pencil)))
        script_execute(gml_Script_scr_enemy_attack_penilla_drawing)
    else if (instance_exists(obj_dialogue_box_battle_transformation_any) && enemy_attack == "Penilla Lines" && obj_heart_battle_fighting_parent.moveable == 1 && (!instance_exists(obj_battle_enemy_attack_penilla_lines_2)))
    {
