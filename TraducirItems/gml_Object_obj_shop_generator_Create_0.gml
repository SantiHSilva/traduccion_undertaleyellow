...
{
    global.shop_item[1] = "Hndw Café"
    global.shop_item[2] = "Hndw Pancake"
    global.shop_item[3] = "G.B. Oso"
    ...
    {
        global.shop_talk[1] = "Este resort."
        global.shop_talk[2] = "¿Qué tal el negocio?"
        global.shop_talk[3] = "La banda"
        global.shop_talk[4] = "Dalv"
    }
    else
    {
        global.shop_talk[1] = "Guardia Real"
        global.shop_talk[2] = "Mo"
        global.shop_talk[3] = "Clima"
        global.shop_talk[4] = "Broma"
    }
    bg_index = 1
...
if (shop_name == "Wild East Gunshop")
{
    ...
    global.shop_talk[1] = "Los Feisty Five"
    global.shop_talk[2] = "Tu mercancía"
    global.shop_talk[3] = "Visitas"
    global.shop_talk[4] = "Historia"
    if (global.dunes_flag[24] != 0)
    {
        global.shop_talk[1] = "Tu edad"
        global.shop_talk[2] = "Los cuatro"
        global.shop_talk[3] = "Humanos"
        global.shop_talk[4] = "Herrero"
    }
    bg_index = 2
...
if (shop_name == "Wild East Saloon")
{
    ...
    global.shop_gold_requirement[3] = 22
    global.shop_gold_requirement[4] = 30
    global.shop_talk[1] = "Este pueblo"
    global.shop_talk[2] = "Tus serpientes"
    global.shop_talk[3] = "¿Puedo irme?"
    global.shop_talk[4] = "North Star"
    if (global.dunes_flag[24] != 0)
    {
        global.shop_talk[1] = "Feisty Five"
        global.shop_talk[2] = "Kanako"
        global.shop_talk[3] = "Gobierno"
...
if (shop_name == "Steamworks Vendy")
{
    ...
    {
        global.shop_talk[1] = "Tu actitud"
        global.shop_talk[2] = "Steamworks"
        global.shop_talk[3] = "Axis"
        global.shop_talk[4] = "Snacks"
    }
    else
    {
        global.shop_talk[1] = "Creador"
        global.shop_talk[2] = "Steamworks"
        global.shop_talk[3] = "Axis"
        global.shop_talk[4] = "Snacks"
    }
...
if (shop_name == "Hotel Shop")
{
    ...
    if (global.hotland_flag[4] == 1)
        global.shop_talk[2] = "Hotland (NUEVO)"
    if (global.hotland_flag[5] == 1)
        global.shop_talk[4] = "Toriel? (NUEVO)"
    bg_index = 5
