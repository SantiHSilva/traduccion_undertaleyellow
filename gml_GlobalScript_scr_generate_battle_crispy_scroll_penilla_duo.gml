function scr_generate_battle_crispy_scroll_penilla_duo() //gml_Script_scr_generate_battle_crispy_scroll_penilla_duo
{
    global.battle_enemy_name_1 = "crispy scroll a"
    ...
    instance_create(116, 120, obj_crispy_scroll_head_a)
    instance_create(116, 120, obj_crispy_scroll_back_a)
    instance_create(60, 120, obj_crispy_scroll_hand_left_a)
    instance_create(172, 120, obj_crispy_scroll_hand_right_a)
    global.enemy_damage_x = obj_crispy_scroll_head_a.x
    global.enemy_damage_y = obj_crispy_scroll_head_a.y
    global.enemy_target_x = obj_crispy_scroll_head_a.x
    global.enemy_target_y = obj_crispy_scroll_head_a.y
    instance_create(472, 240, obj_penilla_body_b)
    instance_create(492, 188, obj_penilla_head_b)
    instance_create(472, 188, obj_penilla_hands_b)
    instance_create(494, 232, obj_penilla_tail_b)
