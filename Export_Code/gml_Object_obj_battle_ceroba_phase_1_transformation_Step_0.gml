...
switch scene
{
    ...
    case 1:
        ...
        if (global.hit_self == 1)
        {
            if ((soul_hurt_count % 2) == 0)
            {
                ...
                audio_play_sound(snd_attackhitcrit, 1, false, 1, 0, random_range(0.8, 1.2))
            }
            global.hit_self = 0
            soul_hurt_count += 1
        }
    ...
    case 4:
        ...
        with (obj_ceroba_body_pacifist_phase_1)
        {
            ...
            else if (image_index >= (image_number - 1))
            {
                ...
                audio_play_sound(snd_ceroba_big_shot, 1, false)
                other.scene++
            }
        }
        break
    ...
    case 18:
        with (obj_ceroba_body_pacifist_phase_1)
        {
            ...
            else if (image_index > 4 && image_index < 16 && (!instance_exists(obj_ceroba_transformation_beam_spawner)))
            {
                ...
                audio_play_sound(snd_ceroba_powerup, 1, false)
            }
    ...
    case 30:
        with (obj_ceroba_transformation_mask)
        {
            ...
            {
                audio_play_sound(snd_ceroba_phase_1_transform, 1, false)
