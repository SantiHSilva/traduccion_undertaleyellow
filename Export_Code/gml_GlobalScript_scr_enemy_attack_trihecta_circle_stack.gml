function scr_enemy_attack_trihecta_circle_stack() //gml_Script_scr_enemy_attack_trihecta_circle_stack
{
    if (!instance_exists(obj_battle_enemy_attack_trihecta_circle_stack_lead))
    {
        ...
        if (random_side == 0)
            var x_side = ((obj_dialogue_box_battle_transformation_any.bbox_left + 5) + 21)
        else
