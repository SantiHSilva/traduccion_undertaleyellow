...
if (instance_exists(obj_dialogue_box_battle_transformation_any) && started == 1)
{
    var can_move = 1
    var execute_collision = 0
    ...
    if (execute_collision == 1)
    {
        ...
        audio_play_sound(snd_trihecta_reflect_balls, 20, false)
