function scr_enemy_timer_attacks_sweet_corn_duo() //gml_Script_scr_enemy_timer_attacks_sweet_corn_duo
{
    var enemy_attack = global.enemy_attack
    if (instance_exists(obj_dialogue_box_battle_transformation_any) && enemy_attack == "Candy Spear Corn" && obj_heart_battle_fighting_parent.moveable == 1)
    {
    ...
    else if (instance_exists(obj_dialogue_box_battle_transformation_any) && enemy_attack == "Homing Spear Corn" && obj_heart_battle_fighting_parent.moveable == 1)
    {
