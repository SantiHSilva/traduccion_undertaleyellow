...
if (intro_noloop == 0)
{
    switch scene
    {
        ...
        case 5:
            ...
            break
        case 6:
            global.battle_music = audio_play_sound(mus_gotcha, 1, true)
            scene++
            break
        case 7:
        ...
        case 7.5:
            ...
            break
        case 8:
            audio_play_sound(mus_f_laugh, 1, false)
        ...
        case 10.5:
            ...
            break
        case 11:
            global.battle_music = audio_play_sound(music_flowey[0], 1, true)
            instance_create_depth(0, 0, 0, controller_flowey[0])
            obj_heart_battle_fighting_yellow_final.moveable = 1
            scene++
            break
        case 12:
            cutscene_wait(1)
...
else
{
        ...
        switch scene
        {
            ...
            case 17:
                if instance_exists(obj_flowey_battle_gray_spawner_pathetic4)
                    return;
                obj_heart_battle_fighting_yellow_final.moveable = 0
                cutscene_dialogue_final_flowey()
                with (msg)
                {
                    skippable = 0
            ...
            case 19:
                ...
                break
            case 20:
                obj_flowey_gray_eyes.stare_at_screen = 0
                obj_flowey_gray_eyes.alarm[0] = 0
    ...
    if (stage_switch != -1)
    {
        ...
        else if (obj_flowey_battle_phase_2_transition.fade_out == 1)
        {
            if (stage_switch == 0)
            {
                scene = 0
            ...
            global.battle_music = audio_play_sound(music_flowey[stage_switch], 1, true)
            for (i = 0; i < array_length(controller_flowey); i++)
            {
                ...
                if (i == stage_switch && (!instance_exists(controller_flowey[i])))
                {
                    ...
                    obj_heart_battle_fighting_yellow_final.moveable = 1
                    obj_heart_battle_fighting_parent.can_shoot = 1
                }
            }
