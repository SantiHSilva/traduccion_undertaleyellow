function scr_battle_core_directory_action_2_selected_event() //gml_Script_scr_battle_core_directory_action_2_selected_event
{
    var event_check = 0
    ...
    else if (game_mode == "yellow")
    {
        ...
        else if (battle_enemy_name == "frostermit a")
        {
            ...
            if (global.action_2_selected_count == 1)
            {
                if (global.enemy_low_hp == 0 && global.enemy_mode == 0)
                {
        ...
        else if (battle_enemy_name == "slither a")
        {
            ...
            var fog_sound = audio_play_sound(snd_undertale_appear, 1, false)
        ...
        else if (battle_enemy_name == "slither b")
        {
            ...
            if (global.action_2_selected_count_2 < 1)
                global.action_2_selected_count_2 += 1
            obj_battle_enemy_effect_slither_fog.target_alpha = 0.5
            fog_sound = audio_play_sound(snd_undertale_appear, 1, false)
            audio_sound_pitch(fog_sound, 0.5)
            global.enemy_attacking = 1
            instance_destroy()
            return;
        ...
        else if (battle_enemy_name == "guardener")
        {
            ...
            {
                var power_sound = audio_play_sound(snd_power_down, 1, false)
                global.action_2_selected_count += 1
                if (global.action_2_selected_count >= 5)
                    global.enemy_sparing = 1
