...
if (obj_pl.state == gml_Script_scr_frozen_state && waiter == 2)
{
    ...
    else if (global.meta_flowey_introduction_count == 1)
    {
        with (msg)
        {
            ...
            message[5] = "* ¡Toriel debería haber#  enseñado cómo funcionan#  las cosas por aquí!"
            message[6] = "* ¿No lo hizo?"
            message[7] = "* Supongo que el#  pequeño y viejo yo#  tendrá que hacerlo entonces."
            ...
            if (outcome == 2)
            {
                ...
                message[12] = "* ¿Esos humanos que#  buuscas?"
                ...
                message[17] = "* También..."
                message[18] = "* Dondequiera que estes#  y necesites ayuda,#  YO puedo ayudarte a GUARDAR!"
