...
if (global.snowdin_flag[13] == 1)
{
    ...
    switch scene
    {
        case 0:
            if scr_timer()
            {
                audio_play_sound(snd_martlet_lands, 1, false)
                scene = 1
            }
            break
        case 1:
        ...
        case 11:
            ...
            if (!global.dialogue_open)
            {
                ...
                audio_play_sound(snd_rock_roll, 1, false)
        ...
        case 29:
            if (!scr_timer())
                return;
            audio_play_sound(snd_big_crash, 1, false)
            instance_create(0, 0, obj_cave_screenshake)
            timer = 90
            scene++
            break
