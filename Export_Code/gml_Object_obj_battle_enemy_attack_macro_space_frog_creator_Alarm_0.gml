...
if (irandom(frog_green_chance) == 1 && frog_green_noloop == 0)
{
    is_green = 1
    frog_green_noloop = 1
    var meteor = instance_create_depth((battle_box.bbox_right + 10), irandom_range((battle_box.bbox_top + 20), (battle_box.bbox_bottom - 20)), -100, obj_battle_enemy_attack_space_green_frog)
}
else
{
