if instance_exists(obj_transition)
    return;
var scripted_encounter_dist = 0
if instance_exists(obj_scriptedencounters)
{
    with (obj_pl)
    {
        if (distance_to_object(obj_scriptedencounters) < 150)
            scripted_encounter_dist = 1
    }
}
if (ds_list_empty(global.encounter_list) || enc_disabled || scripted_encounter_dist == 1 || global.cutscene == true)
    return;
