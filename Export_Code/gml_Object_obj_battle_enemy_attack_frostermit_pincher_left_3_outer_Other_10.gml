if (obj_battle_enemy_attack_frostermit_pincher_left_1.state == "normal")
    var in_angle = point_direction(obj_battle_enemy_attack_frostermit_pincher_left_1.x, obj_battle_enemy_attack_frostermit_pincher_left_1.y, obj_heart_battle_fighting_parent.x, obj_heart_battle_fighting_parent.y)
else
...
x_offset = (46 * cos(degtorad(obj_battle_enemy_attack_frostermit_pincher_left_2.image_angle)))
y_offset = (46 * sin(degtorad(obj_battle_enemy_attack_frostermit_pincher_left_2.image_angle)))
