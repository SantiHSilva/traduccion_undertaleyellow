if (ds_map_find_value(event_data, "event_type") == "sprite event")
{
    switch ds_map_find_value(event_data, "message")
    {
        case "ceroba_ending_sounds":
            audio_play_sound(snd_ceroba_defeated_sounds, 1, false)
            break
        case "ceroba_charge":
            audio_play_sound(snd_ceroba_charge, 1, false)
            break
        case "cloak_sound":
            audio_play_sound(snd_ceroba_cloak, 1, false)
            break
        case "ceroba_scream":
            ...
            obj_petal_generator_phase_2.fade_out = 0
            obj_petal_generator_phase_2.petals_enabled = 1
            audio_play_sound(snd_ceroba_scream, 1, false)
        ...
        case "ceroba_retransform":
            audio_play_sound(snd_ceroba_retransform, 1, false)
            break
    }
