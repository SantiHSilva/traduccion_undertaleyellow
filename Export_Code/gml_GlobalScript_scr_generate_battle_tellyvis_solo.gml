function scr_generate_battle_tellyvis_solo() //gml_Script_scr_generate_battle_tellyvis_solo
{
    global.battle_enemy_name_1 = "tellyvis a"
    ...
    instance_create(316, 200, obj_tellyvis_body_a)
    global.enemy_damage_x = (obj_tellyvis_body_a.x - 12)
    global.enemy_damage_y = (obj_tellyvis_body_a.y - 42)
    global.enemy_target_x = (obj_tellyvis_body_a.x - 12)
    global.enemy_target_y = (obj_tellyvis_body_a.y - 42)
