function scr_generate_battle_shufflers() //gml_Script_scr_generate_battle_shufflers
{
    global.battle_enemy_name_1 = "rephil"
    ...
    global.enemy_hit = 0
    global.enemy_hurt = 0
    global.enemy_attack_stat = 999
    global.enemy_defense_stat = 999
    ...
    if (global.sound_carry_overworld == 0)
    {
        ...
        audio_sound_gain(mus_occupied_turf_yellow, 1, 0)
        audio_sound_pitch(mus_occupied_turf_yellow, 1)
        audio_play_sound(mus_occupied_turf_yellow, 20, true)
    }
    audio_extend = 0
    global.sound_carry_battle = 1
    global.mettaton_voice_count = 1
    instance_create(323, 218, obj_shufflers_rephil)
    ...
    instance_create(393, 134, obj_quote_bubble_battle)
    instance_create(0, 0, obj_quote_battle_shufflers_rephil)
