...
if (global.snowdin_flag[8] == 0)
{
    switch scene
    {
        ...
        case 3:
            ...
            {
                timer = 30
                audio_play_sound(mus_occupied_turf_yellow, 1, true)
                scene++
            }
            break
        case 4:
        ...
        case 5:
            with (toast)
            {
                path_start(pt_toast_jump_snowdin_13_yellow, 5, path_action_stop, 0)
                audio_play_sound(snd_toast_jump, 1, false)
            }
            scene++
            break
        case 6:
    ...
    switch scene
    {
        ...
        case 2:
            if (!instance_exists(obj_dialogue))
            {
                ...
                audio_play_sound(snd_slide_whistle, 20, false)
                scene++
            }
            break
        case 3:
        ...
        case 5:
            if (!instance_exists(obj_dialogue))
            {
                ...
                audio_play_sound(snd_slide_whistle_reversed, 20, false)
                scene++
            }
            break
        case 6:
        ...
        if (!color_noloop)
        {
            for (var i = 0; i < array_length(message); i++)
            {
                if is_array(talker)
                {
                    ...
                    if (talker_current != -4 || other.shufflers_puzzle == 1)
                    {
                        if (talker_current == rephil || other.shufflers_puzzle == 1)
                            new_col = 2
