function scr_determine_enemy_attack_yellow() //gml_Script_scr_determine_enemy_attack_yellow
{
    if live_call()
    ...
    else if (battle_enemy_name == "dalv")
    {
        ...
        if (global.determine_attack_priority == 1)
        {
            ...
            else if (turns_passed == 10)
            {
                ...
                {
                    case 0:
                        if (global.enemy_sparing == 0 && global.enemy_mode_gen == 0)
    ...
    {
        if ((((enemy_dead + enemy_spared) + enemy_dead_2) + enemy_spared_2) < 1 && (!((global.enemy_sparing == 1 && global.enemy_low_hp == 0))) && (!((global.enemy_sparing_2 == 1 && global.enemy_low_hp_2 == 0))))
        {
    ...
    {
        if ((((enemy_dead + enemy_spared) + enemy_dead_2) + enemy_spared_2) < 1 && (!((global.enemy_sparing_2 == 1 && global.enemy_low_hp_2 == 0))))
        {
            random_range_value = irandom_range(0, 1)
            if (random_range_value == 0)
            {
        ...
        else if ((enemy_dead_2 + enemy_spared_2) >= 1 || (global.enemy_sparing_2 == 1 && global.enemy_low_hp_2 == 0))
        {
            random_range_value = irandom_range(0, 9)
            if (random_range_value >= 0 && random_range_value <= 2)
            {
    ...
    {
        if ((((enemy_dead + enemy_spared) + enemy_dead_2) + enemy_spared_2) < 1 && (!((global.enemy_spared == 1 && global.enemy_low_hp == 0))) && (!((global.enemy_spared_2 == 1 && global.enemy_low_hp_2 == 0))))
        {
