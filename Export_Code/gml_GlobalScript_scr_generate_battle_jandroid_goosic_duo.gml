function scr_generate_battle_jandroid_goosic_duo() //gml_Script_scr_generate_battle_jandroid_goosic_duo
{
    ...
    global.current_hp_enemy_2 = 160
    global.max_hp_enemy = 150
    global.max_hp_enemy_2 = 160
    ...
    audio_falloff_set_model(0)
    audio_listener_orientation(0, 0, 1, 0, 1, 0)
    if (global.kill_number[4] <= 7)
    {
        if (global.kill_number[4] > 0)
        {
            audio_play_sound_at(mus_genobattle_yellow, 0, 0, 0, 100, 300, 1, true, 1)
    ...
    {
        audio_play_sound_at(mus_heatwave_approaching, 0, 0, 0, 100, 300, 1, true, 1)
    ...
    instance_create(162, 213, obj_jandroid_body_a)
    ...
    instance_create(470, 160, obj_goosic_body_b)
    global.enemy_damage_x_2 = (obj_goosic_body_b.x - 12)
    global.enemy_damage_y_2 = (obj_goosic_body_b.y - 42)
    global.enemy_target_x_2 = (obj_goosic_body_b.x - 12)
    global.enemy_target_y_2 = (obj_goosic_body_b.y - 42)
