function scr_enemy_timer_attacks_insomnitot_duo() //gml_Script_scr_enemy_timer_attacks_insomnitot_duo
{
    ...
    if (instance_exists(obj_dialogue_box_battle_transformation_any) && obj_heart_battle_fighting_parent.moveable == 1)
    {
        if (enemy_attack == "Insomnitot Sheep ZZZ")
        {
            if (!instance_exists(obj_battle_enemy_attack_insomnitot_fence))
                script_execute(gml_Script_scr_enemy_attack_insomnitot_sheep_stars)
            script_execute(gml_Script_scr_enemy_attack_insomnitot_sheep_zzz)
