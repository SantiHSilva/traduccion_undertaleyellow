function d3d_model_cylinder(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10) //gml_Script_d3d_model_cylinder
{
    var __ind = argument0
    var __x1 = argument1
    var __y1 = argument2
