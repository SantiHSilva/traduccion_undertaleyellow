with (other)
{
    ...
    with (obj_pl)
    {
        ...
        draw_sprite_ext(sprite_index, -1, (x - __view_get((0 << 0), 0)), (((y + (sprite_height * 2)) - (sprite_yoffset * 2)) - __view_get((1 << 0), 0)), 1, -1, 0, c_white, 1)
        draw_set_blend_mode(0)
    }
    shader_reset()
    draw_set_blend_mode(3)
    draw_sprite_ext(spr_snowdin_04_reflection_mask, 0, (-(__view_get((0 << 0), 0))), (-(__view_get((1 << 0), 0))), 4, 4, 0, c_white, 1)
    draw_set_blend_mode(0)
