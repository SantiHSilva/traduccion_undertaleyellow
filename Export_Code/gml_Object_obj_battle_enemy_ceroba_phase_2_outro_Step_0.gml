...
switch scene
{
    case 0:
        ...
        with (obj_heart_yellow_shot)
            instance_destroy()
        audio_play_sound(snd_ceroba_p2_block, 1, false)
    ...
    case 9:
        ...
        audio_play_sound(snd_ceroba_staff_break, 1, false)
        scene++
        break
    case 10:
        cutscene_wait(1)
    ...
    case 30:
        ...
        if (box_overlay_alpha <= 0)
        {
            ...
            obj_heart_battle_fighting_parent.moveable = 1
            obj_heart_battle_fighting_parent.can_shoot = 0
            obj_heart_battle_fighting_yellow_final.can_charge = 0
            scene++
        }
        break
    case 31:
        if (obj_ceroba_phase_2_mercy.button_pressed == 1)
        {
            obj_ceroba_phase_2_mercy.fade_in = 0
            obj_ceroba_phase_2_fight.fade_in = 0
            obj_heart_battle_fighting_parent.moveable = 0
            scene += 1
        }
        if (obj_ceroba_phase_2_fight.button_pressed == 1)
        {
            obj_ceroba_phase_2_mercy.fade_in = 0
            obj_ceroba_phase_2_fight.fade_in = 0
            obj_heart_battle_fighting_parent.moveable = 0
    ...
    case 34:
        ...
        {
            obj_ceroba_phase_2_mercy.fade_in = 1
            obj_ceroba_phase_2_fight.fade_in = 1
            obj_heart_battle_fighting_parent.moveable = 1
            scene++
        }
        break
