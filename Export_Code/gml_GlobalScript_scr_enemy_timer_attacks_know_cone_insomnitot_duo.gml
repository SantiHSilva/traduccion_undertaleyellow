function scr_enemy_timer_attacks_know_cone_insomnitot_duo() //gml_Script_scr_enemy_timer_attacks_know_cone_insomnitot_duo
{
    ...
    if (instance_exists(obj_dialogue_box_battle_transformation_any) && obj_heart_battle_fighting_parent.moveable == 1)
    {
        ...
        {
            script_execute(gml_Script_scr_enemy_attack_know_cone_blueberries_zzz)
        ...
        {
            script_execute(gml_Script_scr_enemy_attack_know_cone_oranges_stars)
            if (global.attack_counter >= 0)
            {
                global.attack_counter -= 1
                if (global.attack_counter < 0)
