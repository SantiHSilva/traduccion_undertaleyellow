function scr_damage_determination_enemy(argument0) //gml_Script_scr_damage_determination_enemy
{
    if live_call()
    ...
    if (button_pressed == 1)
    {
        if (global.enemy_sparing == 1 && global.enemy_vulnerable == 1)
        {
            global.last_hp_enemy = global.current_hp_enemy
            global.current_hp_enemy = 0
            global.enemy_betrayed = 1
        ...
        else if (global.enemy_vulnerable == 1)
        {
