function scr_start_enemy_attacking_crispy_scroll_penilla_duo() //gml_Script_scr_start_enemy_attacking_crispy_scroll_penilla_duo
{
    ...
    if (battle_menu_number == 1)
    {
        if (fight_number == 1)
        {
            ...
            {
                instance_create(220, 64, obj_quote_bubble_battle_yellow_2)
                instance_create(0, 0, obj_quote_battle_crispy_scroll_a)
