function scr_damage_determination_enemy_2(argument0) //gml_Script_scr_damage_determination_enemy_2
{
    switch argument0
    {
        case "Gun Single":
    ...
    if (button_pressed == 1)
    {
        if (global.enemy_sparing_2 == 1 && global.enemy_vulnerable_2 == 1)
        {
            global.last_hp_enemy_2 = global.current_hp_enemy_2
            global.current_hp_enemy_2 = 0
            global.enemy_betrayed_2 = 1
        ...
        else if (global.enemy_vulnerable_2 == 1)
        {
