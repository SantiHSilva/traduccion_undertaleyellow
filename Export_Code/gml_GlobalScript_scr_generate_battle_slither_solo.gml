function scr_generate_battle_slither_solo() //gml_Script_scr_generate_battle_slither_solo
{
    global.battle_enemy_name_1 = "slither a"
    ...
    instance_create(316, 170, obj_slither_body_a)
    global.enemy_damage_x = (obj_slither_body_a.x - 12)
    global.enemy_damage_y = (obj_slither_body_a.y - 42)
    global.enemy_target_x = (obj_slither_body_a.x - 12)
    global.enemy_target_y = (obj_slither_body_a.y - 42)
