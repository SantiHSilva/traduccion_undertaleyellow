...
switch attack_tick
{
    ...
    case 245:
        sound_noloop = 0
        for (i = (battle_box.bbox_top + 12); i < ((battle_box.bbox_top + 4) + 70); i += 14)
        {
    ...
    case 250:
        sound_noloop = 0
        for (i = ((battle_box.bbox_top + 4) + 70); i < ((battle_box.bbox_top + 4) + 140); i += 14)
        {
