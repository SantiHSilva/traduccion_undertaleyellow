...
if ((!global.dialogue_open) && door_menu_open == 1)
{
...
switch scene
{
    case 1:
        ...
        break
    case 2:
        if (global.route != 3 && global.geno_complete[3] == 0)
        {
    ...
    case 3:
        if (image_index == 5)
        {
            if (!audio_is_playing(snd_puzzle_icemelt))
                audio_play_sound(snd_puzzle_icemelt, 1, false)
        }
        if (image_index == 16)
        {
    ...
    case 9:
        with (obj_player_npc)
        {
            path_start(pt_steamworks_chem_05_player_knockback, 6, path_action_stop, 1)
    ...
    case 24:
        ...
        audio_play_sound(snd_chem_05_axis_acid_melt_ground, 1, false)
        break
    case 25:
    ...
    case 29:
        with (obj_axis_npc)
        {
            ...
            {
                audio_play_sound(snd_chem_05_axis_fall, 1, false)
                other.scene++
            }
            y_previous = y
        }
