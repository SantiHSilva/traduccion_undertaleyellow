function scr_generate_battle_sousborg() //gml_Script_scr_generate_battle_sousborg
{
    global.battle_enemy_name_1 = "sousborg"
    ...
    global.hit_self = 0
    global.hurt_self = 0
    global.current_hp_enemy = 180
    global.max_hp_enemy = 180
    ...
    instance_create(0, 0, obj_quote_battle_sousborg_act_spawner)
    instance_create(320, 190, obj_sousborg_body_a)
    global.enemy_damage_x = (obj_sousborg_body_a.x - 12)
    global.enemy_damage_y = (obj_sousborg_body_a.y - 42)
    global.enemy_target_x = (obj_sousborg_body_a.x - 12)
    global.enemy_target_y = (obj_sousborg_body_a.y - 42)
    global.enemy_attack = "Sousborg Flip"
    global.last_action_selected = "None"
}
