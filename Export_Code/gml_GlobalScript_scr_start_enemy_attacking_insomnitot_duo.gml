function scr_start_enemy_attacking_insomnitot_duo() //gml_Script_scr_start_enemy_attacking_insomnitot_duo
{
    ...
    if (battle_menu_number == 1)
    {
        if (fight_number == 1)
        {
            if (enemy_dead == 0 && enemy_spared == 0)
            {
                ...
                instance_create(0, 0, obj_quote_battle_insomnitot_a)
