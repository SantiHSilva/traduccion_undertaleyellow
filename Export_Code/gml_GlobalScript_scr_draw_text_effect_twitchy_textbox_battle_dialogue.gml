function scr_draw_text_effect_twitchy_textbox_battle_dialogue() //gml_Script_scr_draw_text_effect_twitchy_textbox_battle_dialogue
{
    ...
    for (var i = 1; i <= characters; i += 1)
    {
        ...
        if (string_lettersdigits(str_char) == "")
            draw_text(((obj_dialogue_box_battle.x + 136) + str_offset), (obj_dialogue_box_battle.y + 20), string_hash_to_newline((str_indent + str_char)))
        else
            draw_text((((obj_dialogue_box_battle.x + 136) + str_offset) + (twitchy_text_offset_x * twitchy_text_intensity)), ((obj_dialogue_box_battle.y + 20) + (twitchy_text_offset_y * twitchy_text_intensity)), string_hash_to_newline((str_indent + str_char)))
    }
}
