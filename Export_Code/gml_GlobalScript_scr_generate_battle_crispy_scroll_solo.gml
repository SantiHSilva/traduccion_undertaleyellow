function scr_generate_battle_crispy_scroll_solo() //gml_Script_scr_generate_battle_crispy_scroll_solo
{
    ...
    instance_create(318, 120, obj_crispy_scroll_head_a)
    instance_create(318, 120, obj_crispy_scroll_back_a)
    instance_create(262, 120, obj_crispy_scroll_hand_left_a)
    instance_create(374, 120, obj_crispy_scroll_hand_right_a)
