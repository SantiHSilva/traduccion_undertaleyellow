...
draw_text((__view_get((0 << 0), 0) + 200), (__view_get((1 << 0), 0) + 13), string_hash_to_newline("GAME CONFIG"))
...
draw_set_color(c_white)
draw_text(xx, (__view_get((1 << 0), 0) + 110), string_hash_to_newline("ACCESSIBILITY"))
if (position == 2)
    draw_set_color(c_yellow)
draw_text(xx, (__view_get((1 << 0), 0) + 130), string_hash_to_newline("Shake on hurt:"))
draw_set_color(c_white)
if (position == 3)
    draw_set_color(c_yellow)
draw_text(xx, (__view_get((1 << 0), 0) + 145), string_hash_to_newline("Always allow retry:"))
draw_set_color(c_white)
if (position == 4)
    draw_set_color(c_yellow)
draw_text(xx, (__view_get((1 << 0), 0) + 160), string_hash_to_newline("AUTO-SPRINT:"))
draw_set_color(c_white)
if (position == 5)
    draw_set_color(c_yellow)
