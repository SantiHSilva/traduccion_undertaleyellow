function scr_generate_battle_frostermit_know_cone_duo() //gml_Script_scr_generate_battle_frostermit_know_cone_duo
{
    global.battle_enemy_name_1 = "frostermit a"
    global.battle_enemy_name_2 = "know cone b"
    ...
    global.current_hp_enemy_2 = 75
    global.max_hp_enemy = 90
    global.max_hp_enemy_2 = 75
    ...
    global.enemy_exp = 20
    global.enemy_exp_2 = 24
    global.enemy_gold = 5
    global.enemy_gold_2 = 7
    ...
    instance_create(480, 198, obj_frostermit_body_a)
    ...
    instance_create(114, 146, obj_know_cone_body_b)
    instance_create(obj_know_cone_body_b.x, obj_know_cone_body_b.y, obj_know_cone_hand_left_b)
    instance_create(obj_know_cone_body_b.x, obj_know_cone_body_b.y, obj_know_cone_hand_right_b)
    instance_create(obj_know_cone_body_b.x, (obj_know_cone_body_b.y - 90), obj_know_cone_ball_b)
    global.enemy_damage_x_2 = obj_know_cone_body_b.x
    global.enemy_damage_y_2 = obj_know_cone_body_b.y
    global.enemy_target_x_2 = obj_know_cone_body_b.x
    global.enemy_target_y_2 = obj_know_cone_body_b.y
