...
switch scene
{
    ...
    case 0.25:
        ...
        break
    case 0.5:
        if cutscene_npc_walk(1167, obj_player_npc.x, 160, 3, "y", "left")
            cutscene_advance(1)
        break
    case 1:
        cutscene_wait(0.5)
        break
    case 2:
        cutscene_camera_move(190, obj_pl.y, 1, 0)
        break
    case 3:
            ...
            switch message_current
            {
                ...
                case 1:
                    if (noloop_message < message_current)
                    {
                        ...
                        scr_screenshake(6, 2)
                        audio_play_sound(snd_guardener_level10, 1, false)
    ...
    case 21:
        ...
        break
    case 22:
        cutscene_npc_action_sprite(1165, 1554, 1, 0)
    ...
    case 25:
        ...
        break
    case 26:
        cutscene_battle_initiate("axis", 1, 0)
    ...
    case 27:
        ...
        break
    case 28:
        cutscene_npc_action_sprite(1167, 316, 1, 1, 0, 352, 8)
                ...
                switch i
                {
                    ...
                    case 9:
                        if (other.shoot_noloop < i)
                        {
                            ...
                            audio_play_sound(snd_revolver_shoot, 1, false)
                        }
                        break
                }
    ...
    case 34:
        ...
        break
    case 35:
        cutscene_npc_walk_relative(1167, -100, 0, 1, "x", "left")
        break
    case 36:
        cutscene_npc_set_sprites(obj_axis_npc, 2592, 383, 2749, 3415, 2592, 383, 2749, 3415)
        break
    case 37:
        if cutscene_npc_action_sprite(1165, 1415, 1, 0)
            obj_axis_npc.x -= 29
        break
    case 38:
        cutscene_dialogue()
        ...
        break
    case 39:
        cutscene_npc_walk(1165, 280, 180, 2, "y", "right")
        ...
        break
    case 40:
        cutscene_npc_walk(1165, 280, obj_player_npc.y, 2, "y", "right")
        break
    case 41:
        cutscene_wait(1)
        break
