...
switch scene
{
    case 1:
        ...
        break
    case 2:
        var snap_sound = audio_play_sound(snd_flowey_world_snap, 1, false)
    ...
    case 3:
        ...
        break
    case 4:
        snap_sound = audio_play_sound(snd_flowey_world_snap, 1, false)
        audio_sound_pitch(snap_sound, random_range(0.8, 1.2))
        obj_pl.x -= 20
        obj_pl.direction = 0
        if (obj_pl.x > 40)
    ...
    case 8:
        ...
        scr_cutscene_end()
        layer_set_visible("vines_lever", 1)
        layer_set_visible("Decorations_hidable", 0)
        cutscene_advance()
        break
}
