function scr_battle_core_directory_enemy_1_name(argument0, argument1) //gml_Script_scr_battle_core_directory_enemy_1_name
{
    ...
    if (game_mode == "customs")
    {
        ...
        else if (battle_enemy_name == "ms mettaton")
        {
            ...
            else if (ms_mettaton_transformed == 1)
            {
                battle_menu_option_x = (obj_dialogue_box_battle.x + argument0)
                battle_menu_option_y = (obj_dialogue_box_battle.y + argument1)
    ...
    else if (game_mode == "yellow")
    {
        ...
        {
            var battle_enemy_name_1 = global.battle_enemy_name_1
            battle_menu_option_x = (obj_dialogue_box_battle.x + argument0)
            battle_menu_option_y = (obj_dialogue_box_battle.y + argument1)
