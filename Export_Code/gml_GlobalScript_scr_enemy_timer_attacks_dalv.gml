function scr_enemy_timer_attacks_dalv() //gml_Script_scr_enemy_timer_attacks_dalv
{
    ...
    if (instance_exists(obj_dialogue_box_battle_transformation_any) && obj_heart_battle_fighting_parent.moveable == 1)
    {
        ...
        {
            script_execute(gml_Script_scr_enemy_attack_dalv_lightning_vertical)
        ...
        {
            script_execute(gml_Script_scr_enemy_attack_dalv_lightning_dual)
            if (global.attack_counter >= 0)
            {
                global.attack_counter -= 1
                if (global.attack_counter < 0)
        ...
        {
            script_execute(gml_Script_scr_enemy_attack_dalv_lightning_balls)
            if (global.attack_counter >= 0)
            {
                global.attack_counter -= 1
                if (global.attack_counter < 0)
        ...
        else if (enemy_attack == "Dalv Lightning Bolt")
        {
            ...
            if ((!instance_exists(obj_battle_enemy_attack_dalv_lightning_bolt)) && obj_dalv_body.cloak_out == 1)
                script_execute(gml_Script_scr_enemy_attack_dalv_lightning_bolt)
        }
    }
}
