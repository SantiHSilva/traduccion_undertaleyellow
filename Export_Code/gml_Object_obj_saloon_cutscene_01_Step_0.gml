...
switch scene
{
    case 0:
        ...
        {
            music = audio_play_sound(mus_a_new_partner, 1, true)
    ...
    case 3:
        ...
        with (starlo)
        {
            ...
            if (path_index == -1)
            {
                ...
                path_start(pt_saloon_jump, 2, path_action_stop, 0)
            }
        }
        break
    case 4:
    ...
    case 5:
        ...
        if (floor(ed.image_index) == 6)
        {
            ...
            {
                audio_play_sound(snd_gun_hit, 1, false)
                scr_screenshake(6, 1)
            }
        }
    ...
    case 6:
        ...
        with (ed)
        {
            ...
            {
                audio_play_sound(snd_playerjump, 1, false)
                path_start(pt_saloon_jump_off, 2, path_action_stop, 0)
            }
        }
        break
    case 7:
    ...
    case 8:
        ...
        if (!global.dialogue_open)
        {
            scr_music_sudden_stop(music, 10, 0)
            scene++
        }
        break
    case 9:
        ...
        {
            scene++
            obj_saloon_audience.crowd_animate = 1
            timer = 45
        }
        break
    case 10:
        if (!scr_timer())
            return;
        obj_saloon_audience.crowd_animate = 0
        scene++
        break
    case 11:
        scr_text()
    ...
    case 35:
        ...
        with (clover_npc)
        {
            ...
            image_index = 1
            image_speed = 0
            path_start(pt_saloon_clover_stand_up, 2, path_action_stop, 0)
            audio_play_sound(snd_playerjump, 1, false)
        }
        timer = 30
        scene++
    ...
    case 36:
        ...
        {
            clover_npc.action_sprite = 0
            clover_npc.can_walk = 1
