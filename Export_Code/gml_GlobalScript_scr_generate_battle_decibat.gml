function scr_generate_battle_decibat() //gml_Script_scr_generate_battle_decibat
{
    global.battle_enemy_name_1 = "decibat"
    ...
    if (global.sound_carry_overworld == 0)
    {
        ...
        audio_sound_gain(mus_decibat_yellow, 1, 0)
        audio_sound_pitch(mus_decibat_yellow, 1)
        audio_play_sound(mus_decibat_yellow, 20, true)
    }
    audio_extend = 0
    global.sound_carry_battle = 0
    global.mettaton_voice_count = 1
    obj_decibat_head.battle_start = 1
    obj_decibat_body.battle_start = 1
    global.enemy_target_x = obj_decibat_body.x
    global.enemy_target_y = obj_decibat_body.y
    ...
    instance_create(0, 0, obj_background_boss_battle)
