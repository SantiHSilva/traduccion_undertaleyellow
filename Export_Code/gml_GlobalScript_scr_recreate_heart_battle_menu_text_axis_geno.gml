function scr_recreate_heart_battle_menu_text_axis_geno() //gml_Script_scr_recreate_heart_battle_menu_text_axis_geno
{
    var last_text_move_select = global.last_text_move_select
    if (text_deadlock_1 == 1)
        instance_create((obj_dialogue_box_battle.x + 20), (obj_dialogue_box_battle.x + 20), text_deadlock_contents_1)
    else if (global.attack_cycle == global.attack_cycle_max && global.geno_complete[4] == 0)
    {
