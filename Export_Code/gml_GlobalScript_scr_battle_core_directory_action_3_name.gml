function scr_battle_core_directory_action_3_name(argument0, argument1) //gml_Script_scr_battle_core_directory_action_3_name
{
    if (global.battling_boss == 1)
    {
        var battle_enemy_name = global.battle_enemy_name
        if (global.action_3_important == 1)
    ...
    else
    {
        ...
        switch act_number
        {
            ...
            case 2:
                ...
                if (global.action_3_important_2 == 1)
            ...
            case 3:
                ...
                if (global.action_3_important_3 == 1)
