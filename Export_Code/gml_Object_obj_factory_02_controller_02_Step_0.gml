...
switch scene
{
    ...
    case 22:
        ...
        obj_factory_02_seesaw_puzzle.seesaw_puzzle_activate = 1
        break
    case 23:
        break
    case 24:
    ...
    case 27:
        if (!audio_is_playing(mus_mixin_it_up))
        {
            ...
            cutscene_music = audio_play_sound(mus_mixin_it_up, 1, true)
    ...
    case 28:
        ...
        obj_ceroba_npc.npc_dynamic_depth = 1
        cutscene_advance()
        break
    case 29:
    ...
    case 31:
        ...
        with (obj_ceroba_npc)
            path_start(pt_steamworks_factory_02_cerobajump, 4, path_action_stop, 0)
