function cts_shufflers_puzzle() //gml_Script_cts_shufflers_puzzle
{
    ...
    if (timer < 60)
    {
        if (timer >= 0)
        {
            with (obj_snowdin_13_swig)
            {
                ...
                {
                    audio_play_sound(snd_shufflers_flip, 20, false)
    ...
    if (timer == 189)
    {
        ...
        audio_play_sound(shuffle_music, 1, true)
    ...
    {
        if (victory == true)
            audio_play_sound(snd_success, 20, false)
        else
    ...
    if (timer < 460 && (failure == 1 || shufflers_win == 1))
    {
        if (timer >= 435)
        {
            with (obj_snowdin_13_rephil)
        ...
        if (timer == 450)
        {
            with (obj_snowdin_13_toast)
            {
                ...
                else if (image_index == 0)
                {
                    ...
                    if (other.failure == 1)
                        other.shufflers_puzzle = 0
                    else if (other.shufflers_win == 1)
                    {
