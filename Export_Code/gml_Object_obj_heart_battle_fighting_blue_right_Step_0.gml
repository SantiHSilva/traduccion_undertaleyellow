...
if (damage < 1)
    damage = 1
script_execute(gml_Script_scr_controls_battle_heart_blue_right)
...
if (hsp < 20 && floating == false)
    hsp += grav
if (key_left_release && hsp < 0)
{
    hsp = 0
    floating = true
    alarm[1] = 3
}
if ((bbox_right + 1) >= (obj_dialogue_box_battle_transformation_any.bbox_right - 4))
{
    floating = false
    alarm[1] = 0
