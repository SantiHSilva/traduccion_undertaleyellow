...
{
    case "left":
        var wave = instance_create((obj_dialogue_box_battle_transformation_any.bbox_left - 40), obj_dialogue_box_battle_transformation_any.y, obj_battle_enemy_attack_decibat_wave_orange)
        break
    case "right":
