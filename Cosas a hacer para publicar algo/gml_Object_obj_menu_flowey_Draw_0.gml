...
with (other)
{
    ...
    if (room == rm_mainmenu)
    {
        ...
        if (p[2] == 1)
            draw_set_color(c_yellow)
        draw_text((__view_get((0 << 0), 0) + 175), 120, string_hash_to_newline("Reiniciar"))
        draw_set_color(c_white)
        if (p[3] == 1)
            draw_set_color(c_yellow)
        draw_set_halign(fa_center)
        draw_text((__view_get((0 << 0), 0) + 160), 140, string_hash_to_newline("Configuración"))
        draw_set_color(c_white)
        draw_set_color(c_white)
        draw_set_halign(fa_left)
        ini_open("Save.sav")
    ...
    else
    {
        ...
        if (p[1] == 1)
            draw_set_color(c_yellow)
        draw_text(120, 140, string_hash_to_newline("REINICIAR"))
        draw_set_color(c_white)
        if (p[2] == 1)
            draw_set_color(c_yellow)
        draw_text(200, 140, string_hash_to_newline("ESPERAR"))
        draw_set_halign(fa_left)
        draw_set_color(c_white)
    }
}
