function scr_get_input() //gml_Script_scr_get_input
{
    ...
    global.down_keyp = (keyboard_check_pressed(vk_down) || keyboard_check(ord("S"))  || gamepad_button_check_pressed(0, gp_padd) || down_stick)
    global.left_keyp = (keyboard_check_pressed(vk_left) || keyboard_check(ord("A")) || gamepad_button_check_pressed(0, gp_padl) || left_stick)
    global.right_keyp = (keyboard_check_pressed(vk_right) || keyboard_check(ord("D")) || gamepad_button_check_pressed(0, gp_padr) || right_stick)
    global.up_keyp = (keyboard_check_pressed(vk_up)  || keyboard_check(ord("W")) || gamepad_button_check_pressed(0, gp_padu) || up_stick)
