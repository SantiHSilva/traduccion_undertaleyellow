...
if (!is_active)
    return;
if (place_meeting(x, y, obj_battle_enemy_attack_axis_shield) && deflect_noloop == 0)
{
...
if (place_meeting(x, y, obj_axis_body) && is_deflected == 1)
{
    ...
    {
        instance_destroy()
        audio_play_sound(snd_pickaxe_ding, 1, false)
    }
}
var col_generator = instance_place(x, y, obj_battle_enemy_axis_generator)
if (col_generator != noone && is_deflected == 1)
{
    instance_destroy()
