function scr_loadgame() //gml_Script_scr_loadgame
{
    if file_exists("Save.sav")
    {
        ...
        ds_map_add(migracion1, "Mun. Clavos", "Nails")
        ...
        ds_map_add(migracion3, "Parche R.D.", "Delta Rune Patch")
        ...
        ds_map_add(migracionitems, "Mun. Goma", "Rubber Ammo")
        ...
        ds_map_add(migracionitems, "Paleta C.", "Hot Pop")
        ds_map_add(migracionitems, "Paleta T.", "Lukewarm Pop")
        ds_map_add(migracionitems, "Paleta F.", "Cold Pop")
        ds_map_add(migracionitems, "Café Dorado", "G. Coffee")
        ds_map_add(migracionitems, "Café D.", "G. Coffee")
        ds_map_add(migracionitems, "Cactus D.", "G. Cactus")
        ds_map_add(migracionitems, "Soda Adulta", "Adult Soda")
        ds_map_add(migracionitems, "Soda A.", "Adult Soda")
        ...
        ds_map_add(migracionitems, "Pin de Merc.", "Band Merch Pin")
        ds_map_add(migracionitems, "Hebilla de Acero", "Steel Buckle")
        ds_map_add(migracionitems, "Hebilla A.", "Steel Buckle")
        ds_map_add(migracionitems, "C. de Seguridad", "Safety Jacket")
        ds_map_add(migracionitems, "Chaqueta Seg", "Safety Jacket")
        ds_map_add(migracionitems, "G. de Seguridad", "Safety Goggles")
        ds_map_add(migracionitems, "Gafas Seg", "Safety Goggles")
        ds_map_add(migracionitems, "Parche Runa Delta", "Delta Rune Patch")
        ds_map_add(migracionitems, "Parche R.D.", "Delta Rune Patch")
        ...
        ds_map_add(migracionitems, "Cerillos", "Matches")
        ...
        ds_map_add(migracionitems, "Mun. Hielo", "Ice Pellets")
        ds_map_add(migracionitems, "Mun. de Café", "Cff Bean Ammo")
        ds_map_add(migracionitems, "Mun. Café", "Cff Bean Ammo")
        ...
        ds_map_add(migracionitems, "Mun. Pedernal", "Nails")
        ds_map_add(migracionitems, "Mun. Clavos", "Nails")
