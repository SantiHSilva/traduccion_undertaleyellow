function cutscene_npc_set_sprites(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) //gml_Script_cutscene_npc_set_sprites
{
    with (argument0)
    {
        up_sprite = argument1
