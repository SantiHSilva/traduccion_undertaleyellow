function scr_enemy_attack_trihecta_circle_bounce() //gml_Script_scr_enemy_attack_trihecta_circle_bounce
{
    if (!instance_exists(obj_battle_enemy_attack_trihecta_circle_bounce))
    {
        ...
        {
            random_number = -1
            var bbox_var = obj_dialogue_box_battle_transformation_any.bbox_left
        }
        else
