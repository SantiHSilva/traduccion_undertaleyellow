...
if (!variable_global_exists("flowey_phase_2_noloop"))
    global.flowey_phase_2_noloop = 0
intro_noloop = 0
scene = 0
cutscene_timer = 0
draw_alpha = 0
...
intro_song = audio_play_sound(mus_crescendo_of_dread, 1, false)
image_speed = 0
switch_timer = 25
stage_switch = -1
stage_current = 0
...
controller_flowey[1] = 658
controller_flowey[2] = 706
controller_flowey[3] = 1708
controller_flowey[4] = 2937
controller_flowey[5] = 985
controller_flowey[6] = 445
petal_alive = [1, 1, 1, 1, 1, 1]
petal_count = 6
hp_bar_alpha = 0
if (global.flowey_phase_2_noloop == 1)
{
