function scr_determine_enemy_attack() //gml_Script_scr_determine_enemy_attack
{
    ...
    if (battle_enemy_name == "ms mettaton")
    {
        ...
        if (ms_mettaton_transformed == 0 && turns_passed > 4)
        {
            global.turns_passed = 4
            turns_passed = global.turns_passed
        }
        else if (ms_mettaton_transformed == 1 && turns_passed > 19)
        {
