...
if (message_current == con_message_number && con_keep_previous == 1 && item_category == "consumable")
{
    battle_item_use_string = message[(con_message_number - 1)]
    script_execute(gml_Script_scr_draw_text_effect_twitchy_textbox_battle_item_use)
}
