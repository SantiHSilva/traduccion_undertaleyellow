function scr_generate_battle_know_cone_insomnitot_duo() //gml_Script_scr_generate_battle_know_cone_insomnitot_duo
{
    global.battle_enemy_name_1 = "know cone a"
    global.battle_enemy_name_2 = "insomnitot b"
    ...
    global.current_hp_enemy_2 = 80
    global.max_hp_enemy = 80
    global.max_hp_enemy_2 = 80
    ...
    global.enemy_attack_stat_2 = 6
    global.enemy_defense_stat = 7
    global.enemy_defense_stat_2 = 5
    ...
    global.enemy_exp = 24
    global.enemy_exp_2 = 18
    global.enemy_gold = 7
    global.enemy_gold_2 = 5
    ...
    instance_create(116, 146, obj_know_cone_body_a)
    instance_create(obj_know_cone_body_a.x, obj_know_cone_body_a.y, obj_know_cone_hand_left_a)
    instance_create(obj_know_cone_body_a.x, obj_know_cone_body_a.y, obj_know_cone_hand_right_a)
    instance_create(obj_know_cone_body_a.x, (obj_know_cone_body_a.y - 90), obj_know_cone_ball_a)
    global.enemy_damage_x = obj_know_cone_body_a.x
    global.enemy_damage_y = obj_know_cone_body_a.y
    global.enemy_target_x = obj_know_cone_body_a.x
    global.enemy_target_y = obj_know_cone_body_a.y
    instance_create(522, 234, obj_insomnitot_body_b)
    instance_create((obj_insomnitot_body_b.x - 28), (obj_insomnitot_body_b.y - 52), obj_insomnitot_ear_left_b)
    instance_create((obj_insomnitot_body_b.x + 26), (obj_insomnitot_body_b.y - 52), obj_insomnitot_ear_right_b)
    instance_create(obj_insomnitot_body_b.x, obj_insomnitot_body_b.y, obj_insomnitot_foot_left_b)
    instance_create(obj_insomnitot_body_b.x, obj_insomnitot_body_b.y, obj_insomnitot_foot_right_b)
    instance_create((obj_insomnitot_body_b.x + 2), (obj_insomnitot_body_b.y - 22), obj_insomnitot_face_b)
    global.enemy_damage_x_2 = obj_insomnitot_body_b.x
    global.enemy_damage_y_2 = (obj_insomnitot_body_b.y - 22)
    global.enemy_target_x_2 = obj_insomnitot_body_b.x
    global.enemy_target_y_2 = (obj_insomnitot_body_b.y - 22)
