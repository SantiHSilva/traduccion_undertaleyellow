function scr_cutscene_battle_martlet_final_intro() //gml_Script_scr_cutscene_battle_martlet_final_intro
{
    ...
    switch scene
    {
        ...
        case 16:
            ...
            {
                audio_play_sound(snd_final_martlet_transformation, 1, false)
                global.battle_music = audio_play_sound(mus_remedy, 1, true)
            }
            break
        case 17:
            obj_martlet_final_body_intro.image_speed = 1
            draw_enabled = 0
            if ((!instance_exists(obj_screenshake_battle)) && screenshake_noloop == 0)
            {
        ...
        case 21:
            ...
            audio_play_sound(snd_final_martlet_scream, 1, false)
        ...
        case 22:
            ...
            break
        case 23:
            obj_martlet_final_base.martlet_sprites_reset = 1
            cutscene_advance()
            break
        case 24:
            cutscene_wait(1)
