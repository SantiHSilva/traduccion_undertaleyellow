function scr_path_jump(argument0, argument1, argument2, argument3) //gml_Script_scr_path_jump
{
    with (argument0)
    {
        jump_path = path_add()
        ...
        path_set_closed(jump_path, 0)
        path_start(jump_path, 4, path_action_stop, 0)
