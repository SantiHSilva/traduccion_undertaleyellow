...
if (instance_exists(obj_text_damage_count) && global.fight_number == 1 && global.attacking_damage_stat > 0 && no_loop_damage_disjoint_count == 0)
{
    time_elapsed = 0
...
if ((!((instance_exists(obj_text_damage_count) && global.fight_number == 1))) && enemy_dead == 0 && enemy_spared == 0)
{
    ...
    else if (jump_type == 1 && can_jump == 1)
    {
...
if (stomped_on == 1)
{
    ...
    if (stomp_counter >= stomp_counter_max && no_loop_stomp == 0)
    {
        alarm[0] = 30
        no_loop_stomp = 1
    }
