function scr_cutscene_battle_macro_2() //gml_Script_scr_cutscene_battle_macro_2
{
    if live_call()
    ...
    switch scene
    {
        ...
        case 2:
            ...
            audio_play_sound(snd_danza_green_note, 1, false)
            ...
            obj_background_macro_froggit.fade_out = 1
            cutscene_advance()
            break
        case 3:
            draw_enabled = 1
