...
switch scene
{
    ...
    case 6:
        ...
        break
    case 7:
        cutscene_audio_fade(cutscene_music, 0, 500, 0.25, 0)
        break
    case 8:
        cutscene_wait(1)
        break
    ...
    case 12:
        ...
        break
    case 13:
        audio_play_sound(snd_wild_east_bell, 1, false)
    ...
    case 24:
        ...
        break
    case 25:
        cutscene_npc_walk(actor_starlo, 120, 480, 4, "y", "left", 0)
        cutscene_music_start(203)
        break
    case 26:
        if (actor_clover.x > (actor_starlo.x - 40))
        {
            cutscene_npc_walk(actor_clover, 120, 500, 4, "y", "left", 0)
            cutscene_advance()
        }
        break
    case 27:
        ...
        {
            cutscene_npc_walk(actor_ceroba, 120, 440, 4, "y", "left", 0)
            cutscene_advance()
        }
        break
    case 28:
    ...
    case 33:
        ...
        break
    case 34:
        if cutscene_move_all(0, 5, 160, 1000001, 1000004, 1, 0)
            audio_play_sound(snd_wild_east_shocking_sound, 1, false)
        break
    case 35:
        cutscene_wait(2)
        break
    ...
    case 39:
        if (!instance_exists(obj_wild_east_train_lever))
        {
            ...
            audio_play_sound(snd_slide_whistle, 1, false)
        }
    ...
    case 40:
        ...
        break
    case 41:
        if (obj_train_choice.selection_confirmed == 1)
        {
    ...
    case 43:
        ...
        break
    case 44:
        cutscene_camera_move(obj_camera.x, 400, 2, 0)
        break
    case 45:
        if cutscene_npc_walk(actor_train, actor_train.x, (actor_mooch.y - 30), 1, "y", "down")
        {
            audio_play_sound(snd_mo_kick, 1, false)
            scr_screenshake(3, 2)
        }
        scr_audio_fade_out(cutscene_music, 100)
        break
    case 46:
        cutscene_npc_action_sprite(actor_train, 1236, 0.3, 1, 0, 425, 3)
        break
    case 47:
        cutscene_wait(1)
        break
    ...
    case 60:
        ...
        break
    case 61:
        cutscene_move_all(0, -5, 160, 1000001, 1000004, 1, 0)
        break
    case 62:
