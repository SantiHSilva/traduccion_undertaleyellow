...
for (var i = 0; i < thorn_number; i++)
{
    ...
    with (thorn)
    {
        path_start(pt_flowey_battle_phase_2_paper_left, 2, path_action_restart, 1)
    ...
    with (thorn)
    {
        path_start(pt_flowey_battle_phase_2_paper_left_top, 2, path_action_restart, 1)
    ...
    with (thorn)
    {
        path_start(pt_flowey_battle_phase_2_paper_right, 2, path_action_restart, 1)
        path_position = (thorn_pos_multiplier * i)
    }
    ...
    with (thorn)
    {
        path_start(pt_flowey_battle_phase_2_paper_right_top, 2, path_action_restart, 1)
        path_position = ((thorn_pos_multiplier * 0.5) + (thorn_pos_multiplier * i))
    }
}
