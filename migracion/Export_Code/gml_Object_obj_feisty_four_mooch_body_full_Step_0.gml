...
if (mooch_fly_away == 1 && mooch_fly_away_no_loop == 0)
{
...
if (instance_exists(obj_text_damage_count) && ((global.fight_number == 1 && global.enemy_count == 1) || (global.fight_number == 2 && global.enemy_count == 2)) && no_loop_damage_disjoint_count == 0)
{
    time_elapsed = 0
    sign_modifier = 1
