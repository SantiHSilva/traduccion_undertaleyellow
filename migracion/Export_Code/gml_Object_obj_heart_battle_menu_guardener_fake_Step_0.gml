...
if key_select
{
    if (battle_menu_number == 1)
    {
        if (obj_guardener_vines_controller.vine_count[0] <= 0)
        {
            ...
            if (enemy_count >= 2)
            {
                if (global.enemy_dead_2 == 0 && global.enemy_spared_2 == 0)
                    instance_create(0, 0, obj_text_battle_move_selected_enemy_fight_2)
            }
            if (enemy_count >= 3)
            {
                if (global.enemy_dead_3 == 0 && global.enemy_spared_3 == 0)
            ...
            if (enemy_count >= 1)
            {
                if (global.enemy_vulnerable == 0 && global.enemy_dead == 0 && global.enemy_spared == 0)
                {
            ...
            if (enemy_count >= 2)
            {
                if (global.enemy_vulnerable_2 == 0 && global.enemy_dead_2 == 0 && global.enemy_spared_2 == 0)
                {
            ...
            if (enemy_count >= 3)
            {
                if (global.enemy_vulnerable_3 == 0 && global.enemy_dead_3 == 0 && global.enemy_spared_3 == 0)
                {
            ...
            obj_guardener_vines_controller.vine_cut[0] = 1
    }
    if (battle_menu_number == 2)
    {
        if (obj_guardener_vines_controller.vine_count[1] <= 0)
        {
            ...
            obj_guardener_vines_controller.vine_cut[1] = 1
    }
    if (battle_menu_number == 3)
    {
        if (obj_guardener_vines_controller.vine_count[2] <= 0)
        {
            ...
            obj_guardener_vines_controller.vine_cut[2] = 1
    }
    if (battle_menu_number == 4)
    {
        if (obj_guardener_vines_controller.vine_count[3] <= 0)
        {
            ...
            obj_guardener_vines_controller.vine_cut[3] = 1
    }
}
if (key_select == 0)
{
...
if (no_loop_determine_sparing == 0)
{
